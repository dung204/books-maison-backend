...
export class CheckoutStatusRentingToBorrowing1722581637910
  implements MigrationInterface
{
  name = 'CheckoutStatusRentingToBorrowing1722581637910';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."checkouts_status_enum" AS ENUM('BORROWING', 'OVERDUE', 'RETURNED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "checkouts" ALTER COLUMN "status" SET DEFAULT 'BORROWING'`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."checkouts_status_enum_old" AS ENUM('RENTING', 'OVERDUE', 'RETURNED')`,
    );
    await queryRunner.query(
      `ALTER TABLE "checkouts" ALTER COLUMN "status" DROP DEFAULT`,
    );
