...
export class UpdateBookDto {
  @ApiProperty({
    description:
      'The ISBN-10 or ISBN-13 of the book (use `NULL` string if updating to null)',
  ...
  @ApiProperty({
    description:
      'The published year of the book (use `NULL` string if updating to null)',
    example: 1998,
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    description:
      'The publisher of the book (use `NULL` string if updating to null)',
  ...
  @ApiProperty({
    description:
      'The language of the book (use `NULL` string if updating to null)',
    example: 'English',
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    description:
      'The number of pages for the book (use `NULL` string if updating to null)',
    example: 230,
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    description:
      'The image URL of the book (use `NULL` string if updating to null)',
  ...
  @ApiProperty({
    description:
      'The description of the book (use `NULL` string if updating to null)',
    example:
